...
# q80 subset-locality bundle with optional PE-LiNN diagnostic sidecar.
...
Stages:
  plan    Print all q80 subset sidecar commands (default)
...
Notes:
  ...
  - Full-q80 claims remain out of scope; this is subset-locality only.
USAGE
}
...
print_plan() {
  echo "=== q80 subset-locality sidecar plan ==="
...
stage_sa_q0() {
  subset_cmd "S_A" "0-9" "0" "results/hardware/phase3_q80_SA_q0_raw_vs_mit_sidecar.json"
}

stage_sa_q10() {
  subset_cmd "S_A" "0-9" "10" "results/hardware/phase3_q80_SA_q10_raw_vs_mit_sidecar.json"
}

stage_sa_q19() {
  subset_cmd "S_A" "0-9" "19" "results/hardware/phase3_q80_SA_q19_raw_vs_mit_sidecar.json"
}

stage_sb_q0() {
  subset_cmd "S_B" "10-19" "0" "results/hardware/phase3_q80_SB_q0_raw_vs_mit_sidecar.json"
}

stage_sb_q10() {
  subset_cmd "S_B" "10-19" "10" "results/hardware/phase3_q80_SB_q10_raw_vs_mit_sidecar.json"
}
